    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {[
          ...
          <label
            key={key}
            className="flex items-center justify-between cursor-pointer bg-white/5 border border-white/10 rounded-lg px-4 py-3 hover:bg-white/10 transition-colors"
          >
            ...
            <input
              ...
              className="w-5 h-5 rounded border-white/20 bg-white/5 text-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0"
            />
          </label>
        ))}
      </div>
      ...
      <button
        ...
        className="w-full px-6 py-6 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg font-bold text-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:from-gray-600 disabled:to-gray-700"
      >
