      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
          <div className="flex items-center gap-4">
            <button className="w-12 h-12 rounded-full bg-gradient-to-r from-isolo-orange-600 to-isolo-red-600 flex items-center justify-center hover:shadow-isolo transition-shadow">
            ...
            <div className="flex-1">
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-isolo-orange-600 to-isolo-red-600" style={{ width: '0%' }} />
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <div className="text-2xl font-semibold text-isolo-orange-400">
        ...
        <button
          ...
          className="w-full px-6 py-4 bg-gradient-to-r from-isolo-orange-600 to-isolo-red-600 hover:from-isolo-orange-500 hover:to-isolo-red-500 text-white rounded-lg font-semibold transition-all duration-200 shadow-isolo hover:shadow-2xl hover:scale-[1.02]"
        >
